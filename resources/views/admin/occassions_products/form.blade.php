...
<div class="form-group {{$errors->has('name_ar') ? 'has-error' : ''}}" >
    ...
    {!! Form::text('name_ar',$occassion_product->name_ar, ['class' => 'form-control border-input', 'placeholder' => __('admin.tart_cake')]) !!}
...
<div class="form-group {{$errors->has('name_en') ? 'has-error' : ''}}" >
    ...
    {!! Form::text('name_en',$occassion_product->name_en, ['class' => 'form-control border-input', 'placeholder' => 'Tart']) !!}
...
<div class="form-group {{$errors->has('price') ? 'has-error': ''}}" >
    ...
    {!! Form::text('price',$occassion_product->price, ['class' => 'form-control border-input', 'placeholder' => '200 $']) !!}
