...
<div class="form-group {{$errors->has('name_ar') ? 'has-error' : ''}}" >
    ...
    {!! Form::text('name_ar',old('name_ar') ?? $occassion->name_ar , ['class' => 'form-control border-input', 'placeholder' => __('admin.occassion_name_ar')]) !!}
...
<div class="form-group {{$errors->has('name_en') ? 'has-error' : ''}}" >
    ...
    {!! Form::text('name_en', old('name_en') ?? $occassion->name_en, ['class' => 'form-control border-input', 'placeholder' => __('admin.occassion_name_en')]) !!}
