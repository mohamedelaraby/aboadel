...
<div class="form-group {{$errors->has('name_ar') ? 'has-error' : ''}}" >
    ...
    {!! Form::text('name_ar',old('name_ar') ?? $product->name_ar, ['class' => 'form-control border-input', 'placeholder' => __('admin.tart_cake')]) !!}
<span class="text-danger">{{$errors->has('name_ar') ? $errors->first('name_ar') : ''}}</span>
</div>
{{--  Product name in arabic--}}
<div class="form-group {{$errors->has('name_en') ? 'has-error' : ''}}" >
    {!! Form::label(__('admin.product_name_en')) !!}
    {!! Form::text('name_en',old('name_en') ?? $product->name_en, ['class' => 'form-control border-input', 'placeholder' => 'Tart']) !!}
...
<div class="form-group {{$errors->has('price') ? 'has-error': ''}}" >
    ...
    {!! Form::text('price',old('price') ?? $product->price, ['class' => 'form-control border-input', 'placeholder' => '200 $']) !!}
