...
<div class="form-group {{$errors->has('name_ar') ? 'has-error' : ''}}" >
    ...
    {!! Form::text('name_ar', $chef->name_ar , ['class' => 'form-control border-input', 'placeholder' => __('admin.chef_name_ar')]) !!}
<span class="text-danger">{{$errors->has('name_ar') ? $errors->first('name_ar') : ''}}</span>
</div>
{{--  chef name in arabic--}}
<div class="form-group {{$errors->has('name_en') ? 'has-error' : ''}}" >
    {!! Form::label(__('admin.chef_name_en')) !!}
    {!! Form::text('name_en', $chef->name_en, ['class' => 'form-control border-input', 'placeholder' => __('admin.chef_name_en')]) !!}
...
<div class="form-group {{$errors->has('price') ? 'has-error': ''}}">
    ...
    {!! Form::text('price',$chef->price, ['class' => 'form-control border-input', 'placeholder' => '$500']) !!}
