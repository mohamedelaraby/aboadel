      ...
      <section class="uppernav">
        ...
        <div class="container pt-1">
          ...
          <div class="row">
            ...
            <a href="{{route('ar.pages.special_occassions')}}">العربية</a>
      ...
      <div class="row justify-content-center m-auto">
          ...
          <div class="col-md-3 order-2 order-md-1 border-left product_list">
            ...
            <p class="border-bottom pt-4">
              ...
              <a href="{{url('en/occassions/products'). '/' .$occassion->id}}">

                 {{$occassion->name_en}} <span style="float: right;font-size: .7rem;">

                  <i class="fas fa-greater-than"></i></span>
            ...
            <div class="row text-center pt-4">
              ...
              @foreach ($occassions as $product)
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{url('en/occassions/products/'). '/' .$product->id}}"

                      data-caption=" <h5>{{$product->name_en}}</h5>{{$product->price}} EGP ">

                      <img class="img-fluid hvr-grow" src="{{ asset('Uploads/occassions/cover_image/'. $product->image)}}" alt="{{$product->name_en}}"></a>
