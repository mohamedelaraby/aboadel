...
<html lang="en" >
    ...
    <body>
      ...
      <section class="uppernav">
        <div class="container pt-1">
          ...
          <a href="{{route('ar.home')}}">  العربية</a>
            <p class="px-2">|</p>
            <a href="#">English</a>
          </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img class="img-fluid" src="../images/logoen.png" width="150" height="30" alt="logo">
            </a>
   ...
   <section class="gallery">
    <div class="container py-4">
      ...
      @include('pages-en.layouts.gallery')
      {{--  End Gallery section --}}
   </div>
      <!--chef-->
      <section class="chef py-4">
        <div class="container py-5 text-center">
          <a href="{{route('en.pages.chef_chosen')}}"><button class="hvr-wobble-bottom">Chef’s pick <br>of th month</button></a>
        </div>
      </section>
        ...
        <div class="container py-5">
          <div class="row m-auto justify-content-center text-center">
            <div class="col-md" data-aos="flip-up" data-aos-duration="1400">
              <div class="firstgal">
                <a href="{{route('en.contact.contact_us')}}">
            ...
            <div class="col-md" data-aos="flip-up" data-aos-duration="1400">
              <div class="firstgal">
                <a href="{{route('en.pages.share_form')}}"><img class="img-fluid hvr-grow" 
            ...
            <div class="col-md" data-aos="flip-up" data-aos-duration="1400">
              <div class="firstgal">
                <a href="{{route('en.contact.branch')}}"><img class="img-fluid hvr-grow" 
        ...
        <div class="container py-5">
          <div class="row m-auto justify-content-center">
            ...
            <div class="circle hvr-shrink"><a href=https://www.instagram.com/aboadelpastry/?igshid=6y1791ekf05e"><i class="fab fa-instagram"></i></a></div>
              ...
              <div class="droid">
                <img class="img-fluid mt-4 mb-1" style="width: auto; height: auto;" src="{{asset('images/ndroid.png')}}" alt="droid">
                <img class="img-fluid mb-2" style="width: auto; height: auto;" src="{{asset('images/app-store.png')}}" alt="droid">
              </div>
            </div>
          </div>
        </div>
