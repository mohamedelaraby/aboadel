...
<html lang="ar" >
    ...
    <head>
        ...
        <title>Abu Adel | view Menu Products</title>
     ...
     <section class="uppernav">
       ...
       <div class="container pt-1">
         ...
         <div class="row">
           ...
           <a href="{{route('en.pages.category')}}">English</a>
                    ...
                    <div class="row text-center pt-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div style="overflow: hidden;border: solid 1px #D69942;">
                              ...
                              <a href="{{asset('Uploads/categories'. '/'. $product->category_id . '/' . $product->image)}}" 
                                ...
                                <img class="img-fluid hvr-grow"  src="{{asset('Uploads/categories'. '/'. $product->category_id . '/' . $product->image)}}" alt="products">
