...
<html lang="ar" >
     ...
     <section class="uppernav">
       ...
       <div class="container pt-1">
         ...
         <div class="row">
           ...
           <a href="{{route('en.contact.contact_us')}}">english</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <header class="header_image">
        ...
        <img  class="img-fluid" src="{{url('Uploads/header/contactus_page') . '/' . $cover->contactus_image}}" alt="header">
        ...
        <div class="container py-4 text-right">
            ...
            <div class="row justify-content-center m-auto">
                ...
                <div class="col-md-5">
                    ...
                    <h3 class="mb-3">معلومات الاتصال</h3>
                ...
                <div class="col-md products_gallery query">
                  ...
                  <form>
                    ...
                    <input class="my-2 pr-2 py-2" style="width: 100%;" type="text" placeholder="الاسم">

                    <input class="my-2 pr-2 py-2" style="width: 100%;" type="email" placeholder="البريد الالكتروني">

                    <input class="my-2 pr-2 py-2" style="width: 100%;" type="text" placeholder="الموضوع">

                    <textarea class="my-2 pr-2 py-2" style="width: 100%;" cols="30" rows="6" placeholder="الرسالة"></textarea>

                    <input type="submit" class="subbtn rounded" value="ارسل">
