...
<html lang="ar" >
   ...
   <section class="gallery">
    <div class="container py-4">
      ...
      @include('pages-ar.layouts.gallery')
      {{--  End Gallery section --}}
   </div>
  </section>
      <!--chef-->
      <section class="chef py-4">
        ...
        <a href="{{route('ar.pages.chef_chosen')}}"><button class="hvr-wobble-bottom">اختيار الشيف <br>لهذا الشهر</button></a>
        </div>
      </section>
      <!--store-->
      <section class="store">
        <div class="container py-5">
          <div class="row m-auto justify-content-center text-center">
            <div class="col-md" data-aos="flip-up" data-aos-duration="1400">
              <div class="firstgal">
              <a href="{{route('ar.contact.contact_us')}}">
                <img class="img-fluid hvr-grow" 
                src="{{asset('images/store3.jpg')}}" alt="store"></a>
              </div>
              <h4 class="pt-2">اتصل بنا الآن</h4>
            </div>
            <div class="col-md" data-aos="flip-up" data-aos-duration="1400">
              <div class="firstgal">
                <a href="{{route('ar.pages.share_form')}}"><img class="img-fluid hvr-grow" 
                    src="{{asset('images/store2.jpg')}}" alt="store"></a>
              </div>
              <h4 class="pt-2">شارك في الاستبيان</h4>
            </div>
            <div class="col-md" data-aos="flip-up" data-aos-duration="1400">
              <div class="firstgal">
                <a href="{{route('ar.contact.branch')}}"><img class="img-fluid hvr-grow" 
                    src="{{asset('images/store1.jpg')}}" alt="store"></a>
              </div>
              <h4 class="pt-2">ابحث عن أقرب فرع لك</h4>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="form">
        <div class="container py-5">
          <div class="row justify-content-center m-auto">
            ...
            <div style="overflow: hidden;" class="col-md text-right">
              <form class="py-4" data-aos="fade-right">
                <h3 style="color: #CB913F;">النشرة البريدية</h3>
                <input class="py-1" type="text" placeholder=" الاسم">
                <input class="my-3 py-1" type="email" placeholder=" البريد الالكتروني"><br>
                <input class="sub py-1 mt-1 rounded" type="submit" value="سجل معنا">
              </form>
            </div>
          </div>
        </div>
