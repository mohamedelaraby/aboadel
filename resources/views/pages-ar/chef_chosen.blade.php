...
<html lang="ar" >
     ...
     <section class="uppernav">
       ...
       <div class="container pt-1">
         ...
         <div class="row">
           ...
           <a href="{{route('en.pages.chef_chosen')}}">english</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <header class="header_image">
        ...
        <img class="img-fluid" src="{{url('Uploads/header/chef_page') . '/' . $cover->chef_image}}" alt="header">

        <div class="container">

          <div class="header-content text-center">

            <p> اختيارالشيف الشهري</hp>
                      ...
                      <div class="col-md-4">
                        ...
                        <div style="overflow: hidden;border: solid 1px #D69942;">
                          ...
                          <a href="{{ asset('Uploads/chefs/'. $chef->image)}}" 
                            ...
                            data-caption=" <h5>{{$chef->name_ar}}</h5>{{$chef->price}} جنيه "
