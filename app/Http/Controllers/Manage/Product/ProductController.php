...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $validateData =  $this->validate($request,
        ...
        // Upload cover image
        $image->move('Uploads/categories/' . $category_id,$filenameToStore);

       // Save product to database
            $product = new Product;
            
            $product->category_id = $category_id;
            $product->name_ar = strip_tags(preg_replace('/\s+/', ' ',  $request->input('name_ar')));
            $product->name_en = strip_tags(preg_replace('/\s+/', ' ',  $request->input('name_en')));
            $product->price = strip_tags(preg_replace('/\s+/', ' ',  $request->input('price')));
    ...
    $request->session()->flash('msg',trans('admin.product_added'));
